import 'package:bootcamp_starter/api/active_sharing_api.dart';
    ...
    return Scaffold(
        body:
          FutureBuilder<List<Users>>(
            future: ActiveSharing().nearestSender(SharedPreController().getValueFor(key: Prefkeys.token.name)??''),
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        onPressed: (){
                          ...
                          ActiveSharing().nearestSender(SharedPreController().getValueFor(key: Prefkeys.token.name)??'');
                        },
                    ...
                    ElevatedButton(
                        onPressed: (){
                          ActiveSharing().removeActive(SharedPreController().getValueFor(key: Prefkeys.token.name)??'');
                        },
                        style: ElevatedButton.styleFrom(
                      ...
                      itemBuilder: (BuildContext context,  int index){
                        return Container(
                          ...
                          child:  ListTile(
                            ...
                            title: CustomText( text: snapshot.data![index].name,fontSize: 18,),
...
//                         child: ListTile(
//                           leading: Icon(
//                             Icons.person, size: 34, color: Colors.black,),
